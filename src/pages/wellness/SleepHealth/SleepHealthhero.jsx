...
const HealthlineSleepHealthPage = () => {
  ...
  const articles = [
    {
      id: 1,
      title: "10 Sleep Habits to Improve Every Aspect of Your Health",
      description: "We've rounded up the 10 best and most effective sleep habits to enhance your...",
    ...
    {
      id: 2,
      title: "The Best Sleep-Promoting Foods for Better Rest",
      description: "These sleep-friendly foods help regulate your sleep cycle and support your...",
      image: "https://images.unsplash.com/photo-1518911710364-17ec553bde5d?w=400&h=250&fit=crop",
    ...
    {
      id: 3,
      title: "A Beginner's Guide to Sleep Hygiene",
      description: "Establishing good sleep hygiene is an excellent way to improve sleep quality and maintain...",
      image: "https://images.unsplash.com/photo-1586368939344-48171a53d386?w=400&h=250&fit=crop",
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-1/2 right-10 w-40 h-40 bg-blue-100 rounded-full opacity-30 animate-bounce"></div>
        <div className="absolute bottom-20 left-1/3 w-24 h-24 bg-purple-100 rounded-full opacity-25 animate-pulse delay-1000"></div>
      </div>
      ...
      >
        <div className="container mx-auto px-4 py-8 lg:py-16">
          <div className="flex flex-wrap items-center justify-between relative">
            ...
            >
              {/* Two people sleeping peacefully */}
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1541781774459-bb2af2f05b55?w=120&h=120&fit=crop&crop=face"
              ...
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1520206183501-b80df61043c2?w=120&h=120&fit=crop&crop=face"
                  alt="Person with sleep mask"
                  className="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-4 border-white shadow-lg"
                />
              </div>

              {/* Person with sleep tracker */}
              <div className="relative ml-8">
                <img
                  src="https://images.unsplash.com/photo-1586368939344-48171a53d386?w=150&h=150&fit=crop&crop=face"
                  alt="Person with sleep tracker"
                  className="w-24 h-24 lg:w-32 lg:h-32 rounded-full object-cover border-4 border-white shadow-lg"
                />
              </div>
            </div>

            {/* Center Content - Indigo Circle with Text */}
            <div
            ...
            >
              <div className="bg-indigo-600 rounded-full w-64 h-64 lg:w-80 lg:h-80 flex flex-col items-center justify-center text-white relative">
                <div className="text-center">
                  <div className="text-sm lg:text-base font-medium mb-2">healthline</div>
                  <div className="text-4xl lg:text-6xl font-bold mb-2">Sleep</div>
                  <div className="text-lg lg:text-xl">The rest that restores you</div>
                </div>
              </div>
            </div>
            ...
            >
              {/* Person with relaxation techniques */}
              <div className="relative mr-8">
                <img
                  src="https://images.unsplash.com/photo-1545205597-3d9d02c29597?w=150&h=150&fit=crop&crop=face"
                  alt="Person practicing relaxation"
                  className="w-24 h-24 lg:w-32 lg:h-32 rounded-full object-cover border-4 border-white shadow-lg"
                />
              </div>

              {/* Person with sleep environment */}
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1505693416388-ac5ce068fe85?w=120&h=120&fit=crop&crop=face"
                  alt="Peaceful sleep environment"
                  className="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-4 border-white shadow-lg"
                />
              </div>

              {/* Person with sleep app */}
              <div className="relative">
                <img
                  src="https://images.unsplash.com/photo-1586368939344-48171a53d386?w=120&h=120&fit=crop&crop=face"
                  alt="Person using sleep app"
                  className="w-20 h-20 lg:w-24 lg:h-24 rounded-full object-cover border-4 border-white shadow-lg"
                />
              </div>
            </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div
              ...
              onClick={() =>
                setSelectedArticle({
                  id: "main",
                  title: "Welcome to Healthline Sleep: A Letter from the Editor",
                  description:
          ...
          <div className="bg-white rounded-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto transform animate-scale-in shadow-2xl">
            ...
            <div className="p-8">
              <div className="flex items-center gap-2 mb-4">
                <span className="bg-indigo-100 text-indigo-700 px-3 py-2 rounded-full text-sm font-medium">
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl p-8 max-w-md w-full transform animate-scale-in shadow-2xl">
            <div className="text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-800 mb-2">Share Healthline Sleep</h3>
              <p className="text-gray-600 mb-6">
                Help others discover effective sleep strategies that improve their health and wellbeing!
              </p>
...
export default HealthlineSleepHealthPage
