...
const MigrainehealthApp = () => {
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-3">Welcome to Your Migraine Management Journey</h3>
          <p className="text-gray-600 mb-6 leading-relaxed">
            We're here to support your migraine management every step of the way. Find resources, guidance, and expert
            care for optimal headache relief and prevention strategies.
          </p>
          <button
        ...
        <div className="max-w-6xl w-full text-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up-delay">
              Comprehensive migraine management and headache relief resources for optimal pain control and prevention
              throughout life
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 mb-12">
            {[
              { title: "Migraine Assessment", key: "assessment", gradient: "from-blue-400 to-cyan-400", delay: "0s" },
              { title: "Headache Types", key: "conditions", gradient: "from-green-400 to-emerald-400", delay: "0.1s" },
              {
  ...
  const AssessmentPage = () => {
    const resources = [
      {
        title: "Understanding Your Migraine Diagnosis",
        description: "A comprehensive guide to help you understand migraine assessment and headache evaluation...",
        fullDescription:
          "Proper migraine diagnosis is crucial for effective treatment and management. This resource explains what happens during a comprehensive headache evaluation, the different diagnostic criteria doctors use, how to track your symptoms effectively, and what various tests and assessments mean for your migraine management plan.",
        icon: "🔍",
        bgColor: "bg-gradient-to-br from-blue-400 to-cyan-500",
      },
      {
        title: "Building Your Migraine Care Team",
        description: "Learn about the different specialists who will be part of your headache management journey...",
        fullDescription:
          "Migraine care involves various specialists depending on your needs. Discover the roles of neurologists, headache specialists, pain management doctors, and other healthcare professionals. Understand how to communicate effectively with your migraine care team and coordinate treatment for complex headache conditions.",
        icon: "👥",
        bgColor: "bg-gradient-to-br from-teal-400 to-green-500",
      },
      {
        title: "Migraine Treatment Approaches",
        description: "Making informed decisions about your migraine treatment and management options...",
        fullDescription:
          "Learn about different migraine treatment approaches including acute medications, preventive therapies, and non-pharmacological interventions. Understand the benefits and considerations of each approach, how to evaluate what works best for your specific migraine pattern, and how to make informed decisions about your headache care.",
        icon: "💊",
            ...
            <div className="group bg-white/80 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:rotate-1 border border-white/30 animate-slide-in-left">
              ...
              <div className="p-6 md:p-8">
                <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4 leading-tight group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-purple-600 group-hover:to-pink-600 group-hover:bg-clip-text transition-all duration-300">
                  Complete Migraine Management Guide
                </h2>
                <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                  Your comprehensive resource for understanding migraine assessment, headache types, and optimal pain
...
export default MigrainehealthApp
