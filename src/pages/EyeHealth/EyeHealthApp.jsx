...
const EyeHealthApp = () => {
    ...
    >
      ...
      >
        <div className="text-center">
          ...
          <h3 className="text-2xl font-bold text-gray-800 mb-3">Welcome to Your Vision Care Journey</h3>
          <p className="text-gray-600 mb-6 leading-relaxed">
            We're here to support your eye health every step of the way. Find resources, guidance, and expert care for
            optimal vision wellness.
          </p>
          <button
        ...
        <div className="max-w-6xl w-full text-center">
          ...
          <div className="animate-fade-in-up">
            ...
            <p className="text-lg md:text-xl text-gray-700 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up-delay">
              Comprehensive vision care and eye health resources for optimal sight and wellness throughout life
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 mb-12">
            {[
              { title: "Vision Assessment", key: "assessment", gradient: "from-blue-400 to-cyan-400", delay: "0s" },
              { title: "Eye Conditions", key: "conditions", gradient: "from-green-400 to-emerald-400", delay: "0.1s" },
              {
              ...
              { title: "Vision Wellness", key: "wellness", gradient: "from-orange-400 to-amber-400", delay: "0.4s" },
            ].map((category, index) => (
              <div
                key={category.key}
  ...
  const AssessmentPage = () => {
    const resources = [
      {
        title: "Understanding Your Eye Exam",
        description: "A comprehensive guide to help you understand your vision assessment and eye health evaluation...",
        fullDescription:
          "Regular eye exams are crucial for maintaining optimal vision and detecting eye conditions early. This resource explains what happens during a comprehensive eye exam, the different tests your eye doctor may perform, how to interpret your prescription, and what various measurements mean for your eye health.",
        icon: "🔍",
        bgColor: "bg-gradient-to-br from-blue-400 to-cyan-500",
      },
      {
        title: "Building Your Eye Care Team",
        description: "Learn about the different specialists who will be part of your vision care journey...",
        fullDescription:
          "Eye care involves various specialists depending on your needs. Discover the roles of optometrists, ophthalmologists, opticians, and other vision care professionals. Understand how to communicate effectively with your eye care team and coordinate care for complex vision conditions.",
        icon: "👥",
        bgColor: "bg-gradient-to-br from-teal-400 to-green-500",
      },
      {
        title: "Vision Correction Options",
        description: "Making informed decisions about your vision correction and treatment options...",
        fullDescription:
          "Learn about different vision correction methods including glasses, contact lenses, and surgical options like LASIK. Understand the benefits and considerations of each approach, how to evaluate what works best for your lifestyle, and how to make informed decisions about your vision care.",
        icon: "👓",
            ...
            <div className="group bg-white/80 backdrop-blur-lg rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 hover:rotate-1 border border-white/30 animate-slide-in-left">
              ...
              <div className="p-6 md:p-8">
                ...
                <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                  Your comprehensive resource for understanding vision assessment, eye conditions, and optimal eye care
                  practices.
                </p>
              </div>
            </div>
